...
const numUnfunded = GAMES_JSON.reduce(getSum, 0);

// create a string that explains the number of unfunded games using the ternary operator
let displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${numGames} games. Currently, ${numUnfunded} ${(numUnfunded > 1) ? 'games remain' : 'game remains'} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const fundContainer = document.createElement('p');
fundContainer.textContent = displayStr;

descriptionContainer.appendChild(fundContainer);
...
const firstContainer = document.createElement('p');
firstContainer.innerHTML = firstName;
firstGameContainer.appendChild(firstContainer);

// do the same for the runner-up item
const secondName = second.name;
const secondContainer = document.createElement('p');
secondContainer.innerHTML = secondName;
